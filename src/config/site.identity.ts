export const siteIdentity = {
  code: process.env.NEXT_PUBLIC_SITE_CODE || 'vrexpressok',
  name: process.env.NEXT_PUBLIC_SITE_NAME || 'Vrexpressok',
  ...
  domain: process.env.NEXT_PUBLIC_SITE_DOMAIN || 'vrexpressok.com',
  url: process.env.NEXT_PUBLIC_SITE_URL || 'https://vrexpressok.com',
