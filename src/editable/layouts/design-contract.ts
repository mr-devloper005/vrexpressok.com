...
export const editableRootStyle = {
  '--slot4-page-bg': '#eef0f5',
  '--slot4-page-text': '#071421',
  '--slot4-panel-bg': '#f4f2f2',
  '--slot4-surface-bg': '#ffffff',
  '--slot4-muted-text': '#657282',
  '--slot4-soft-muted-text': '#8d96a3',
  '--slot4-accent': '#20a85d',
  '--slot4-accent-fill': '#20a85d',
  '--slot4-accent-soft': '#dff5e9',
  '--slot4-on-accent': '#ffffff',
  '--slot4-dark-bg': '#1D2128',
  '--slot4-dark-text': '#ffffff',
  '--slot4-media-bg': '#dfe4ea',
  '--slot4-cream': '#ffffff',
  '--slot4-warm': '#f4f2f2',
  '--slot4-lavender': '#ffffff',
  '--slot4-gray': '#eef0f5',
  '--slot4-body-gradient': 'none',
  '--editable-page-bg': '#eef0f5',
  '--editable-page-text': '#071421',
  '--editable-container': '1310px',
  '--editable-border': '#dde3ea',
  '--editable-nav-bg': '#ffffff',
  '--editable-nav-text': '#213040',
  '--editable-nav-active': '#20a85d',
  '--editable-nav-active-text': '#ffffff',
  '--editable-cta-bg': '#20a85d',
  '--editable-cta-text': '#ffffff',
  '--editable-search-bg': '#ffffff',
  '--editable-footer-bg': '#ffffff',
  '--editable-footer-text': '#071421',
} as CSSProperties
